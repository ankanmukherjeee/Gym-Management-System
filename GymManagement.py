...
conn = sqlite3.connect('fzgyms.db')
...
class GymApp(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.title('FZ Gym Management')
        self.configure(bg='#cc2626')
        self.geometry('850x625')
        l1 = tk.Label(self, text = 'Welcome to FZ Gym Centers', font=("Times", 28, "bold"), bg='#cc2626').pack()
...
class Login(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.configure(bg='#cc2626')
        label = tk.Label(self, text = 'Sign In Here!', font=("Times", 30, "italic"), bg='#cc2626').pack(pady=10, padx=10)
    ...
    def authenticate(self):
        ...
        for row in r:
            if self.ev1.get() == row[0] and self.ev2.get() == row[1]:
                ...
                messagebox.showinfo('Login Successful', 'Welcome to FZ Gym Management System!!')
                flag = 1
                conn.commit()
                cur.close()
...
class Menu(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.configure(bg='#cc2626')
        label = tk.Label(self, text = 'Start Menu', font=("Times", 30, "italic"), bg='#cc2626').pack(pady=24, padx=10)
...
class AddCustomer(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Frame.__init__(self, parent)
        self.configure(bg='#cc2626')
        label = tk.Label(self, text = 'Add Customer', font=("Times", 30, "italic"), bg='#cc2626').pack(pady=10, padx=10)
        ...
        success = tk.Label(self, text = '', font=("Times", 10, "italic"), bg='#cc2626', textvariable = self.text).pack(pady=6, padx=10)
...
class AddPackage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Frame.__init__(self, parent)
        self.configure(bg='#cc2626')
        label = tk.Label(self, text = 'Add Package', font=("Times", 30, "italic"), bg='#cc2626').pack(pady=10, padx=10)
...
class ShowCustomers(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Frame.__init__(self, parent)
        self.configure(bg='#cc2626')
        label = tk.Label(self, text = 'List of Customers', font=("Times", 30, "italic"), bg='#cc2626').pack(padx=10)
...
class ShowPackages(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Frame.__init__(self, parent)
        self.configure(bg='#cc2626')
        label = tk.Label(self, text = 'List of Packages', font=("Times", 30, "italic"), bg='#cc2626').pack(padx=10)
...
class SearchCustomer(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Frame.__init__(self, parent)
        self.configure(bg='#cc2626')
        label = tk.Label(self, text = 'Search Customer by Name', font=("Times", 30, "italic"), bg='#cc2626').pack(padx=10)
...
class AddSubscription(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text = 'Add Subscription', font=("Times", 30, "italic"), bg='#cc2626').pack(padx=10, pady=15)
...
class AddPayment(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Frame.__init__(self, parent)
        self.configure(bg='#cc2626')
        label = tk.Label(self, text = 'Add Payment', font=("Times", 30, "italic"), bg='#cc2626').pack(padx=10, pady=15)
        ...
        invoiceBill = tk.Label(self, text = '', font=("Times", 20, "italic"), bg='#cc2626', textvariable = self.invoice).pack(pady=12, padx=10)
        b1 = tk.Button(self, text = 'Submit', relief='raised', font=("Times", 18), width=10, command=self.addPayment).pack(pady=10)
        b2 = tk.Button(self, text = 'Menu', relief='raised', font=("Times", 18), width=10, command=lambda: controller.show_frame(Menu)).pack(pady=10)
        self.text = tk.StringVar(value = '')
        success = tk.Label(self, text = '', font=("Times", 10, "italic"), bg='#cc2626', textvariable = self.text).pack(pady=4, padx=16)
